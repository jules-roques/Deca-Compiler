...
public abstract class AbstractIdentifier extends AbstractLValue {
     ...
     */
    public abstract Type verifyType(DecacCompiler compiler, boolean typeMethod) throws ContextualError;

    public abstract Type verifyClassExpr(DecacCompiler compiler) throws ContextualError;

    public abstract Type verifyMethodExpr(DecacCompiler compiler, ClassDefinition methodClass, ClassDefinition currentClass) throws ContextualError;
}
