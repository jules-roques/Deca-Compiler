...
public class IMAProgram {
    ...
    public void addCommentAtFirst(String s) {
        lines.addFirst(new Line(null, null, s));
    }
    ...
    public void addInstructionAtFirst(Instruction i) {
        lines.addFirst(new Line(null, i, null));
    }

    public void addInstructionAtFirst(Instruction i, String s) {
